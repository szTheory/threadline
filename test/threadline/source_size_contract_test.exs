defmodule Threadline.SourceSizeContractTest do
  ...
  @file_exceptions %{
    ...
    "lib/threadline/operator_surface/mechanical_checker.ex" => {948, @splitting},
    ...
    "lib/threadline/operator_surface/style.ex" => {4509, @splitting},
    "lib/threadline/operator_surface/ui.ex" => {1686, @splitting},
    "lib/threadline/query.ex" => {895, @splitting}
  }
  ...
  @function_exceptions %{
    ...
    {"lib/threadline/operator_surface/style.ex", :css, 1} => {4492, @splitting}
  }
  ...
  @banner_exceptions %{
    ...
    "lib/threadline/operator_surface/mechanical_checker.ex" => 10,
