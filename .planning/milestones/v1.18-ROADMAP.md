...
**Status:** Complete (all 5 phases shipped; ready for milestone close)
...
- [x] **Phase 67: Drift-Aware Redaction Admin & Mix Task Parity** — Render the read-only config-vs-deployed redaction reconciliation viewer (column-only, never sample values) with `pg_proc.prosrc` introspection and the parity `mix threadline.policy.show` task (completed 2026-05-07)
- [x] **Phase 68: Lifecycle Ergonomics** — Revisit first-hour onboarding to mount the surface end-to-end, ship optional-Phoenix-deps upgrade-path docs, and close ADOPT-07 with fresh formatter/CI evidence plus stale blocker retirement (completed 2026-05-07)
...
**Plans**: 3/3 plans complete
- [x] 68-01-PLAN.md — Mounted onboarding closeout: canonical first-hour `/audit` path across `guides/getting-started-saas.md`, `README.md`, `examples/threadline_phoenix/README.md`, and doc-contract coverage (ADOPT-05)
- [x] 68-02-PLAN.md — Optional-deps lifecycle closeout: canonical `guides/upgrade-path.md`, operator-surface cross-linking, ExDoc extras wiring, and doc-contract coverage for support matrix and policy literals (ADOPT-06)
- [x] 68-03-PLAN.md — ADOPT-07 closeout: final-tree `mix verify.format` / `mix ci.all` evidence plus stale blocker retirement across active planning artifacts (ADOPT-07)
...
- ✅ **v1.18 — Adoption and Policy Hardening** — Phases 64-68 (shipped 2026-05-07) — [requirements](REQUIREMENTS.md)
...
| 68. Lifecycle Ergonomics | 3/3 | Complete | 2026-05-07 |
