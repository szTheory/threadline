# Requirements Archive: v1.38 Operator UI Page-by-Page IA & Design-System Polish

**Archived:** 2026-06-30
**Status:** SHIPPED

Fresh requirements should be created with `/gsd-new-milestone` before the next milestone begins.
