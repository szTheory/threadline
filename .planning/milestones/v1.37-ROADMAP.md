...
- [x] 179-01-PLAN.md — Shell, home, and route-stable IA relabeling
- [x] 179-02-PLAN.md — Shared state grammar and unsupported/export-denied copy
- [x] 179-03-PLAN.md — Actor, transaction, row-history, and coverage copy normalization
- [x] 179-04-PLAN.md — Timeline explanatory copy, invalid-filter guidance, and E2E alignment
- [x] 179-05-PLAN.md — Evidence/export, redaction, and retention governance copy
- [x] 179-06-PLAN.md — Stress-route copy-state evidence and closeout verification
...
- [x] 180-01-PLAN.md — Rendered-state A11Y-01 browser coverage and narrow fixes
- [x] 180-02-PLAN.md — APG semantics, non-color cues, and target-size guardrails
- [x] 180-03-PLAN.md — Motion and reduced-motion source/rendered guardrails
- [x] 180-04-PLAN.md — Guardrail matrix, automated accessibility-tree evidence, residual CI classification, and adversarial closeout
