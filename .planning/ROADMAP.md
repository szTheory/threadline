...
- [ ] **Phase 128: README + phx-gen-auth Mount Parity** — Close README Quick Start and phx-gen-auth mount footguns
- [ ] **Phase 129: WALKTHROUGH Truth** — Fix verify cwd and row-history URL honesty in maintainer runbook
