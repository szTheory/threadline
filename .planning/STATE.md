...
**Current focus:** Hold — planning next milestone
...
| post-v1.29 | Hold mode | **Active** — default after v1.29 ships |
...
- **v1.29 (2026-05-29):** Last optional synthetic hygiene pass shipped; default hold until adopter signal.
...
- Run `/gsd-new-milestone` — default recommendation: **Hold**
