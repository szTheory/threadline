...
- [ ] **NARR-02**: README, getting-started, and how-threadline-works cross-links agree on write-path guidance and discovery order.
- [ ] **NARR-03**: Doc-contract tests lock at least one canonical `Audit.transaction/3` narrative literal in how-threadline-works (or equivalent SSOT guide).
