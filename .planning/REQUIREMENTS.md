...
- [ ] **SCHEMA-02**: Ecto schema prefix behavior is proven or corrected so configurable storage schemas do not silently read from or write to the hardcoded `threadline` prefix.
- [ ] **SCHEMA-03**: Generated migration SQL quotes validated storage-schema identifiers consistently, or the supported identifier contract is narrowed, documented, and test-locked.
