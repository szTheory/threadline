...
- Hosted GitHub Actions run `34749550424` passed every check on the Req dependency graph, including the Elixir 1.15 / OTP 26 minimum-version lane, current-version suite, Dialyzer, package, docs, browser, and Tier A jobs.
...
- [x] `threats_open: 0` confirmed after hosted minimum-version CI
- [x] `status: verified` set after hosted minimum-version CI
