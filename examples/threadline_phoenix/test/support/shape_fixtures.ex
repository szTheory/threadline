defmodule ThreadlinePhoenix.ShapeFixtures.CodeKeyed do
  @moduledoc false
...
defmodule ThreadlinePhoenix.ShapeFixtures.Composite do
  @moduledoc false
...
defmodule ThreadlinePhoenix.ShapeFixtures.Join do
  @moduledoc false
  # TWIN-01 shape fixture: no primary key at all, addressed only through the
  # `primary_key:` override declared in config/test.exs (left_id, right_id).
  use Ecto.Schema
...
defmodule ThreadlinePhoenix.ShapeFixtures.TwinPublic do
  @moduledoc false
...
defmodule ThreadlinePhoenix.ShapeFixtures.TwinShapes do
  @moduledoc false
...
defmodule ThreadlinePhoenix.ShapeFixtures.LongName do
  @moduledoc false
