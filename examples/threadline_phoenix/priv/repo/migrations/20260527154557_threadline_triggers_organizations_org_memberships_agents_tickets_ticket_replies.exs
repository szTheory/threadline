defmodule ThreadlineTriggersOrganizationsOrgMembershipsAgentsTicketsTicketReplies do
  ...
  def down do
    ...
    execute "DROP FUNCTION IF EXISTS threadline_capture_changes_ticket_replies() CASCADE"
  end
end
