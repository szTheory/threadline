...
Threadline **0.10.2** is the in-repo, doc, and [Hex](https://hex.pm/packages/threadline) SSOT (`mix.exs` `@version`). See [`guides/adoption-pilot-backlog.md`](adoption-pilot-backlog.md) Distribution preflight for maintainer attestation and publish workflow evidence. <!-- x-release-please-version -->
