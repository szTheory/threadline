...
Distribution preflight below reflects the **0.10.2** tree (`mix.exs` `@version` is SSOT); lane and upgrade narrative live in [`guides/upgrade-path.md`](upgrade-path.md). <!-- x-release-please-version -->
